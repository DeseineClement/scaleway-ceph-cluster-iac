...
###### ISCM NODE ############################################################
variable "iscm_node_count" {
  type        = number
  description = "The amount of ISCM node(s) to have"
  default     = 0
}

variable "iscm_node_image_name" {
  type        = string
  description = "The name of the image to use for ISCM node(s)."
}